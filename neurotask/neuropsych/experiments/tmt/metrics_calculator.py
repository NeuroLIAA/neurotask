...
from neuropsych.experiments.tmt.metrics import calculate_total_distance, number_of_correct_and_incorrect_segments, \
...
from neuropsych.experiments.tmt.model.tmt_model import TMTExperiment, TMTSubject, TMTTrial
from neuropsych.experiments.tmt.segmentation.segmentation import calculate_segmentation_trial_metrics, \
...
def create_invalid_trial_row(
    ...
    return {
        ...
        "trial_type": trial.trial_type.name,
        "trial_order_of_appearance": trial.order_of_appearance,
        "correct_targets_touches": 0,
        "wrong_targets_touches": 0,
        "speed_threshold": speed_threshold,
        "mean_speed": np.nan,
        "std_speed": np.nan,
        "peak_speed": np.nan,
